 ...
 * `closeActiveRound` aplica de verdade — com o placar e as séries já
 * disputadas na rodada em curso. Ela é uma previsão, não uma promessa:
 * enquanto faltar jogo, o placar muda e o delta muda com ele. É por isso que
 * a tela rotula esses destaques como parciais.
 *
